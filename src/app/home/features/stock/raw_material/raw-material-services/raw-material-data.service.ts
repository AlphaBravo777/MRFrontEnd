...
export class RawMaterialDataService {
    ...
    createHardcodedStock(): Observable<any[]> {
        const data = [
            // tslint:disable
            { id: 1, stockName: 'MDM Batch 105', category: 'MDM', supplier: 'Federated', baseUnitSize: 15, measureUnit: 'kg', modelGroup: 'MDM', price: '12.50', active: true },
            { id: 2, stockName: 'Erythrozine', category: 'Ingredients', supplier: 'ABC', baseUnitSize: 50, measureUnit: 'lt', modelGroup: 'Erythrozine', price: '77.50', active: true },
            { id: 3, stockName: 'Isolate', category: 'Ingredients', supplier: 'Crown National', baseUnitSize: 20, measureUnit: 'kg', modelGroup: 'Isolate', price: '21.50', active: true },
            { id: 4, stockName: 'MDM Batch 98', category: 'MDM', supplier: 'Federated', baseUnitSize: 20, measureUnit: 'kg', modelGroup: 'MDM', price: '9.75', active: true },
            { id: 5, stockName: 'Russian Brown', category: 'Ingredients', supplier: 'DFG', baseUnitSize: 40, measureUnit: 'lt', modelGroup: 'Russian Brown', price: '45.30', active: true },
            { id: 6, stockName: 'Vencor Russian Spice', category: 'Spices', supplier: 'Freddy Hirch', baseUnitSize: 15, measureUnit: 'kg', modelGroup: 'Vencor Russian Spice', price: '45.00', active: true },
            { id: 7, stockName: 'PnP Premium Chicken Vienna ', category: 'Spices', supplier: 'Freddy Hirch', baseUnitSize: 15, measureUnit: 'kg', modelGroup: 'PnP Premium Chicken Vienna', price: '50.00', active: true },
            { id: 8, stockName: 'Vencor Russian 1kg', category: 'Labels - Brands', supplier: 'DFG', baseUnitSize: 1000, measureUnit: 'units', modelGroup: 'Vencor Russian 1kg', price: '15.30', active: true },
            { id: 9, stockName: 'Freshers RV 1kg', category: 'Labels - Brands', supplier: 'DFG', baseUnitSize: 1000, measureUnit: 'units', modelGroup: 'Freshers RV 1kg', price: '17.80', active: true },
            { id: 10, stockName: 'MDM Batch 102', category: 'MDM', supplier: 'Azine', baseUnitSize: 18, measureUnit: 'kg', modelGroup: 'MDM', price: '11.00', active: true },
            { id: 11, stockName: 'Labels Regular Use - Radiant Green', category: 'Labels - Generic', supplier: 'ERTS', baseUnitSize: 3000, measureUnit: 'units', modelGroup: 'Labels Regular Use - Radiant Green', price: '23.50', active: true },
            { id: 12, stockName: 'Bags Clear (600x900)', category: 'Packaging - Bags', supplier: 'VB', baseUnitSize: 1000, measureUnit: 'units', modelGroup: 'Bags Clear (600x900)', price: '16.10', active: true },
            { id: 13, stockName: 'Bags Clear (300x600)', category: 'Packaging - Bags', supplier: 'VB', baseUnitSize: 1000, measureUnit: 'units', modelGroup: 'Bags Clear (300x600)', price: '18.70', active: true },
            { id: 14, stockName: 'Lidding Vencor Red Vienna 1kg', category: 'Packaging - Lidding', supplier: 'LKJFGT', baseUnitSize: 500, measureUnit: 'm', modelGroup: 'Lidding Vencor Red Vienna 1kg', price: '365.50', active: true },
            // tslint:enable
        ];
        return of(data);
    }
